...
Want to test your knowledge using real jobs challenges? Here is a public list of open-source cybersecurity challenges from jobs around the world.

Feel free to contribute! Only open-source challenges please!

| | Company | Stack | Test
|--|--|--|--
| :canada: | [Coveo](https://www.coveo.com) | Python | [Code →](https://github.com/coveo/cloud-threat-detection-challenge)
